...
namespace MedicalExaminer.API.Tests.Services.Location
{
        ...
        LocationsQueryService>
    {
        ...
        {
            // Arrange
            var query = new LocationsRetrievalByQuery(false, null, null, forLookup);
        ...
        {
            // Arrange
            var query = new LocationsRetrievalByQuery(false, "Name2", null, forLookup);
        ...
        {
            // Arrange
            var query = new LocationsRetrievalByQuery(false, null, "Name1", forLookup);
        ...
        {
            // Arrange
            var query = new LocationsRetrievalByQuery(false, "Name2", "Name1", forLookup);
        ...
        public async Task Handle_ReturnsFiltered_WhenFilteredByPermissedLocations(bool forLookup)
        {
            ...
            var query = new LocationsRetrievalByQuery(false, null, null, forLookup, permissedLocations);
